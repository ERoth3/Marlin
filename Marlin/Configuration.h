...
#define STRING_CONFIG_H_AUTHOR "(ERoth3, default config)" // Who made the changes.
...
// Ultimaker
    #define  DEFAULT_Kp 55.49
    #define  DEFAULT_Ki 8.82
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {44.44,44.44,2272.73,755}  // default steps per unit for Ultimaker
